...
plot(PROCESSED_FILE_PATH, ['Time'], ['U_DC'], type='line', title='U_DC vs Time', Y_label='DC bus Voltage' ,Y_unit='V', style='display')
plot(PROCESSED_FILE_PATH, ['Time'], ['P_acdc', 'P_PV', 'P_EVs'], type='line', title='P_acdc, P_PV, and P_EVs vs Time', Y_label='Power', Y_unit='W', style='display')
plot(PROCESSED_FILE_PATH, ['Time'], ['P_EVs1', 'P_EVs2', 'P_EVs3', 'P_EVs4', 'P_EVs5'], type='areas', title='P_EVs1, P_EVs2, P_EVs3, P_EVs4, and P_EVs5 vs Time', Y_label='Power', Y_unit='W', style='display')